...
if __name__ == "__main__":
    ...
    def switch_view(self, parent_frame, view_function, title=""):
        """Affiche une vue dans le panneau de contenu spécifié."""
        # Si le treeview existe et qu'on s'apprête à détruire son parent,
        # on doit d'abord réinitialiser la référence python pour éviter les erreurs.
        if self.country_tree and self.country_tree.winfo_exists():
            # La destruction réelle se fera dans la boucle ci-dessous.
